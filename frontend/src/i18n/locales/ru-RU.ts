export default {
  ...
  auth: {
    ...
    accountRequired: 'Введите учётную запись',
  ...
  knowledgeBase: {
    ...
    editDocumentName: 'Изменить название документа',
    documentNamePlaceholder: 'Введите отображаемое название',
    documentNameRequired: 'Укажите название документа',
